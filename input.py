...
p_o2=0.11 #external supply(prop/min)
p_test=5E-7 #by Tp cells (prop/min/cell)
s_test = 0 #external supply(prop/min)
...
K=1
#Environmental Carrying capacity (given as K_i, max in the main text)
rho_Tpos=8.35E4
rho_Tpro=9.62E4
rho_Tneg=1.34E4
#Resource limits
...
eff_name = 'o2-HE_test-LE'
f_name='All3-init-ratios/1.1.1/pop_size-0.5k/' #path to raw data directories; not included here
