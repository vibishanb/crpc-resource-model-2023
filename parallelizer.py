...
try:
    os.makedirs("/data/therapy-models/"+f_name)
except:
    pass
...
def solve_parm(parms=None): #calls the solve_eq function with all default inputs other than lims
    f_name_i=f_name+eff_name
    ee.solve_eq(t_max,dt,y0,p,mu,lam,r,K,delta,rho,lim,f_name_i,therapy=False,therapy_parms=None)

solve_parm()

# The following code was used for running parallelised simulations over large sets of parameter values 
